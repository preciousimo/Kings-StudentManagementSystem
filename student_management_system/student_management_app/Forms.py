...
class AddStudentForm(forms.Form):
    ...
    term_start = forms.DateField(label = "Term Begins")
    term_end = forms.DateField(label = "Term Ends")
    session_start = forms.DateField(label = "Session Begins")
    session_end = forms.DateField(label = "Session Ends")