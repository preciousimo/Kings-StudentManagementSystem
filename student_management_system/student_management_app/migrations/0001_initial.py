# Generated by Django 3.2.10 on 2022-03-15 10:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.session')),
                ('term_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.term')),
            ],
        ),
        migrations.CreateModel(
            name='Staffs',
